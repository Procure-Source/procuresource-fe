...
export const marketPages: FooterLandingPage[] = [
  {
    ...
    summary:
      "ProcureSource supports UAE procurement teams with supplier discovery, RFQ workflows, certification review, and technical product intelligence for fast-moving construction and industrial projects.",
    highlights: ["Dubai and Abu Dhabi supplier visibility", "AHRI, UL, SASO, ISO and consultant-ready records", "RFQ and submittal workflows for local procurement teams"],
  ...
  },
  {
    ...
    summary:
      "The Saudi Arabia market page connects purchase managers with technical product data, supplier records, compliance requirements, and RFQ workflows for industrial procurement.",
  ...
  },
  {
    ...
    subtitle: "Doha-focused procurement intelligence for verified products, suppliers, and RFQs.",
    summary:
    ...
    highlights: ["Doha supplier visibility", "Certification and product record review", "RFQ workflows for project procurement"],
  ...
  },
  {
    ...
    subtitle: "Kuwait City coverage for MEP equipment, industrial suppliers, and RFQ workflows.",
    summary:
    ...
    highlights: ["Kuwait City market coverage", "Verified MEP and industrial supplier records", "Submittal and compliance workflow support"],
  ...
  },
  {
    ...
    highlights: ["Muscat procurement coverage", "MEP product and supplier search", "RFQ and document review workflows"],
  ...
  },
  {
    ...
    highlights: ["Manama supplier coverage", "Verified technical data workflows", "Procurement collaboration across buyers and suppliers"],
...
export const globalPages: FooterLandingPage[] = [
  {
    ...
    subtitle: "International manufacturer intelligence and compliance-aware procurement workflows.",
    summary:
  ...
  },
  {
    ...
    summary:
      "ProcureSource helps connect product records, brand data, certifications, and supplier pathways for North American equipment entering GCC project workflows.",
  ...
  },
  {
    ...
    summary:
      "ProcureSource supports international sourcing by connecting equipment details, supplier documentation, logistics context, and project-ready procurement workflows.",
  ...
  },
  {
    ...
    highlights: ["AHRI, UL, SASO and ISO review support", "Compliance matrix workflows", "Consultant-ready technical summaries"],
  ...
  },
  {
    ...
    subtitle: "Procurement intelligence for efficient equipment selection and documented project decisions.",
    summary:
