        ...
        <table role="presentation" width="520" cellspacing="0" cellpadding="0" style="background:#ffffff;border-radius:18px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.06);">
          ...
          <tr>
            <td style="padding:40px 40px 20px;">
              <h2 style="margin:0 0 8px;font-size:20px;font-weight:600;color:#1d1d1f;">Reset your password</h2>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" style="margin:0 auto;">
                <tr>
                  <td style="border-radius:980px;background:#0066cc;">
                    <a href="${resetUrl}" target="_blank" style="display:inline-block;padding:14px 36px;font-size:15px;font-weight:600;color:#ffffff;text-decoration:none;border-radius:980px;">
                      Reset Password
                    </a>
                  </td>
                </tr>
              ...
              <p style="margin:28px 0 0;font-size:13px;line-height:1.6;color:#86868b;">
                This link expires in <strong>1 hour</strong>. If you didn't request this, you can safely ignore this email — your password will remain unchanged.
              </p>
            </td>
          </tr>
          <!-- Fallback URL -->
